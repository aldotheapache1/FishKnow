...
//                popUp.showAsDropDown(v, 0, 0); // show popup like dropdown list
        ...
        conf.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ArMeasureActivity.this, ListaMedir.class);
                //setar a medicao dentro do peixe
                intent.putExtra("result", getResultado());

                if(anchors.size() >=2){
                    intent.setClass(ArMeasureActivity.this, ListaMedir.class);
